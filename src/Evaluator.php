...
class Evaluator implements EvaluatorInterface
{
     ...
     *
     * @var \Periloso\Evaluator\Contracts\AdapterInterface
     */
    protected $adapter;
     ...
     * @param \Periloso\Evaluator\Contracts\AdapterInterface $adapter
     */
     ...
     * @param  \Periloso\Evaluator\Collection $collection
     * @return integer
     */
    protected function calculate(Fluent $expression, Collection $collection)
    {
        ...
        $target = $this->isMultiplying($expression, $collection);
     ...
     * @return integer
     */
    protected function isMultiplying(Fluent $expression, Collection $collection)
    {
